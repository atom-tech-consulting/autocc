...
- [ ] **TB-5** **Add Codex real-SDK smoke test against examples/taskflow** `#codex` `#smoke` `#tests` [→ brief](.cc-autopilot/tasks/add-codex-real-sdk-smoke-test-against-ex.md)
