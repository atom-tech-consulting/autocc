...
- [x] **TB-11** **Replace Codex e2e smoke with tmux-driven TUI test + document hook-trust prereq** `#codex` `#smoke` `#tests` `#tui` [→ brief](.cc-autopilot/tasks/replace-codex-e2e-smoke-with-tmux-driven.md)
